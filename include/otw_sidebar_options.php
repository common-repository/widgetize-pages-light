...
$db_values = array();
$db_values['otw_smb_promotions'] = get_option( $otw_wpl_plugin_id.'_dnms' );
...
$message = '';
$massages = array();
$messages[1] = esc_html__( 'Options saved', 'otw_wpl' );
...
<div class="wrap">
	...
	<h2>
		<?php esc_html_e('Plugin Options', 'otw_sbm') ?>
	</h2>
	<div class="form-wrap otw-options" id="poststuff">
		<form method="post" action="" class="validate">
			<input type="hidden" name="otw_wpl_action" value="manage_otw_options" />
			<?php wp_original_referer_field(true, 'previous'); wp_nonce_field('otw-wpl-options'); ?>
			...
			<div id="post-body">
				<div id="post-body-content">
					...
					<p class="submit">
						<input type="submit" value="<?php esc_html_e( 'Save Options', 'otw_wpl') ?>" name="submit" class="button button-primary button-hero"/>
					</p>
				</div>
			</div>
		</form>
